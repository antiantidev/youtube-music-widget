...
async function RequestCode() {
  const response = await fetch(
    "http://localhost:9863/api/v1/auth/requestcode",
    {
      method: "POST",
      body: JSON.stringify({
        appId: appId,
  ...
  } else return await responseData;
}
...
function OpenInstructions() {
  window
    .open(
      "https://www.notion.so/nuttylmao/YouTube-Music-Widget-18d19969b23780e2bb56d25eed4d154e",
      "_blank"
    )
    .focus();
}
